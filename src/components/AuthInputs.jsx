...
export default function AuthInputs() {
  ...
  return (
    <div
      id="auth-inputs"
      className="flex flex-col items-center border-2 border-yellow-700 rounded-lg px-3 py-2 mx-auto w-1/3 md:w-1/4"
    >
      <h1>To continue, please sign in or sign up</h1>
